...
for i = 1:n
    ...
    C_pi = pidtune(G_plant, 'PI', 10, opts);
...
ds     = 57.3340659280;                    % = pi * 18.25 m
s_trig = 72.3340659280 + ds*(0:3);         % 4 crossings
%      = [72.334  129.668  187.002  244.336]

steer.tau = 0.03; %steering filter